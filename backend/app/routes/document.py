"""
API routes for document management and text extraction.
Handles uploading, processing, and CRUD operations for documents.
"""
...
async def extract_text(file: UploadFile = File(...)):
    """
    Extracts plain text from various file formats (TXT, PDF, PPTX, DOCX).
    Returns the extracted content as a JSON response.
    """
    try:
